Transfers city table transactional to another database. To get some input for the city table you can use the world db from mysql https://dev.mysql.com/doc/index-other.html.
